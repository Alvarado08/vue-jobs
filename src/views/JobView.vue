...
<template>
  <section class="bg-green-50">
    ...
    <div class="container m-auto py-10 px-6">
      ...
      <div v-if="state.isLoading" class="flex justify-center text-gray-500">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <h2 class="text-2xl">{{ state.job.companyName }}</h2>

            <p class="my-2">
              {{ state.job.companyDescription }}
            </p>
            ...
            <p class="my-2 bg-green-100 p-2 font-bold">
              {{ state.job.companyEmail }}
            </p>

            <h3 class="text-xl">Contact Phone:</h3>

            <p class="my-2 bg-green-100 p-2 font-bold">
              {{ state.job.companyPhone }}
            </p>
          </div>
